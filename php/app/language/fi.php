...
$GLOBALS['language']['fi'] = array(
    ...
    'title_Navigation.Menu' => 'Mealbookers',
    ...
    'title_Navigation.Menu.AccountSettings' => 'Käyttäjätiedot',
    'title_Navigation.Menu.GroupSettings' => 'Ryhmät',
    ...
    'no_meals' => 'Ruokalistaa ei saatavilla',
    ...
    'account_settings' => 'Käyttäjätiedot',
    'account_settings_user_fetch_failed' => 'Käyttäjän haku käyttäjätietoihin epäonnistui',
    ...
    'account_notification_primary_header' => 'Ensisijainen ilmoitustapa',
    'account_notification_primary_email' => 'Sähköposti',
    'account_notification_primary_android_app' => 'Android-sovellus',
    ...
    'terms_of_use_text' => '<strong>Palvelun kuvaus</strong><br />Palvelun avulla voit selata Otaniemen'
        ...
        . ' <br />Käyttäjätietoja ei luovuteta eteenpäin kolmansille osapuolille. Pidätämme kuitenkin oikeuden'
        . ' luoda ja välittää anonyymejä käyttötilastoja.<br /><br /><strong>Palvelun käyttö</strong><br />Palvelua tulee'
        . ' käyttää käyttöehtojen mukaisesti ja häiritsemättä muita palvelun käyttäjiä. Monista'
        ...
        . ' web-palvelusta. Emme vastaa palvelun, palvelun käytön tai palvelun sisällön aiheuttamista suorista,'
        . ' epäsuorista, erityisistä tai välillisistä vahingoista, häiriöistä tai menetyksistä.<br /><br />'
        . ' <strong>Muutokset</strong><br />Pidätämme oikeudet muutoksiin palvelussa sekä sen käyttöehdoissa.'
        . ' Käyttöehtojen muutokset ilmoitetaan käyttäjille tätä tekstiä päivittämällä. Palvelun käyttäjät'
        . ' hyväksyvät muutokset käyttämällä palvelua, minkä vuoksi on suositeltavaa tarkastaa käyttöehdot säännöllisesti.',
    'backend_only' => array(
        ...
        'mailer_body_suggestion_deleted' =>
            'Hei!<br /><br />{canceler} peruikin ehdotuksensa:<br /><br /><strong>{restaurant}</strong>'
            . ' <strong>{suggestion_date}</strong> klo <strong>{suggestion_time}</strong>'
            . ' <br /><br />Voit siirtyä Mealbookersiin <a href="http://{http_host}/#/menu/{day}">tästä</a>.'
            . ' <br /><br />- Mealbookers<br /><br /><small>Tämä on automaattinen viesti,'
            . ' johon ei tarvitse vastata.</small>',
