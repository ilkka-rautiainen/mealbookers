...
$GLOBALS['language']['en'] = array(
    ...
    'account_notification_primary_header' => 'Primary notification method',
    'account_notification_primary_email' => 'Email',
    'account_notification_primary_android_app' => 'Android application',
    ...
    'terms_of_use_text' => '<strong>Description of the service</strong><br />You can view the menus of the'
        ...
        . ' <br /><br /><strong>Use of the service</strong><br />Service should be used as these terms state and not'
    ...
    'backend_only' => array(
        ...
        'mailer_body_suggestion_deleted' =>
            'Hello!<br /><br />{canceler} canceled his/her suggestion:<br /><br /><strong>{restaurant}</strong>'
            . ' <strong>{suggestion_date}</strong> at <strong>{suggestion_time}</strong>'
            . ' <br /><br />You can go to Mealbookers <a href="http://{http_host}/#/menu/{day}">here</a>.'
            . ' <br /><br />- Mealbookers<br /><br /><small>This is an automatic mail.'
            . ' You don\'t need to reply to it.</small>',
        ...
        'mailer_body_invite' =>
            ...
            . ' <br /><br /><br />- Mealbookers<br /><br /><small>This is an automatic mail.'
            . ' You don\'t need to reply to it. / Tämä on automaattinen viesti, johon ei tarvitse vastata.</small>',
